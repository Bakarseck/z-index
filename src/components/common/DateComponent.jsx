    ...
    return (
        <div className="relative p-2 rounded-full">
            ...
            <div className="relative z-10 flex flex-col items-center justify-center h-full text-center text-black">
                <span className="mt-5 text-xs font-bold tracking-wider text-white uppercase">{dateInfo.dayOfWeek}</span>
                <span className="text-4xl font-bold text-white">{dateInfo.dayOfMonth}</span>
