      ...
      <div className="min-h-screen font-sans bg-gradient-to-r from-blue-300 via-red-200 to-yellow-100">
        <header className="flex items-center justify-between px-6 py-4">
          ...
          <nav>
            <ul className="flex space-x-4">
              <li><a href="#" className="text-yellow-500 hover:text-yellow-600">À propos de nous</a></li>
              <li><a href="#" className="text-yellow-500 hover:text-yellow-600">Connexion</a></li>
              <li><a href="#" className="text-yellow-500 hover:text-yellow-600">Inscription</a></li>
            </ul>
          </nav>
        </header>
        ...
        <main className="flex items-center justify-center h-screen">
          <div className="p-6 mr-10 text-black bg-yellow-400 rounded-lg shadow-lg">
            ...
            <button className="px-4 py-2 mt-4 text-white bg-red-500 rounded-full hover:bg-red-600">Je m'inscris</button>
          </div>
